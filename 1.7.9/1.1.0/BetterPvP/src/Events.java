...
public class Events implements Listener {
	...
	public void onPlayerDeathEvent(PlayerDeathEvent event) {
		...
		String deathmoneytype = plugin.getConfig().getString("ondeath.money.type");
		String deathhonortype = plugin.getConfig().getString("ondeath.honor.type");
		Double deathmoney = plugin.getConfig().getDouble("ondeath.money.money");
...
//=============================================HONNOR================================================================
		...
		String ondeathpostpostpostpostmessage = ondeathpostpostpostmessage.replace("%Money", Double.toString(deathmoney));
		String ondeathpostpostpostpostpostmessage = ondeathpostpostpostpostmessage.replace("%TotalHonor", Double.toString(DHonor));
		String ondeathfinalmessage = ChatColor.translateAlternateColorCodes('&', ondeathpostpostpostpostpostmessage);
		// ONDEATH MESSAGE
...
// KILLED - PLAYER ===================================================================
	    // MONEY - START
	    if(eco == true){
	    	if(deathmoneytype.equals("add")){
	    		BetterPvP.econ.depositPlayer(killed.getName(),deathmoney);
	    	}
	    	else if(deathmoneytype.equals("remove")){
	    		BetterPvP.econ.withdrawPlayer(killed.getName(),deathmoney);
	    	}
	    }
	    // MONEY - END
